    ...
    private func loadPeople() {
        var loadedPeople = [
            ...
            Person(name: "Kate", age: 32, tags: ["ArtCollector", "Wanderlust", "WineTasting"],
                   ...
                   imageName: "kate",connectionIntent: "World-travelers who can keep up with my pace and pour a good glass of Syrah.",location: "Barcelona, Spain (GMT+2)",
            ...
            Person(name: "Jaclyn", age: 29, tags: ["Fashion", "Gossip", "Schemes"],
                   ...
                   imageName: "jaclyn",connectionIntent: "People with good taste and a better secret — drama’s more fun with friends.",
            ...
            Person(name: "Chloe", age: 24, tags: ["Astrology", "Yoga", "Manifesting"],
                   ...
                   imageName: "chloe",connectionIntent: "People who vibe high, love moon phases, and won’t judge my crystal collection.",
            ...
            Person(name: "Gary", age: 51, tags: ["FinanceBro", "Whiskey", "Control"],
                   ...
                   imageName: "gary",connectionIntent: "Someone who understands work-life imbalance and can challenge me without a PowerPoint.",
            ...
            Person(name: "Belinda", age: 38, tags: ["Healing", "Listening", "SelfGrowth"],
                   ...
                   imageName: "belinda",connectionIntent: "Genuine, grounded people who value real connection — not just conversation.",location: "New York City, USA (GMT-4)",
                   contactNumber: "+1 (917) 555-0144"
